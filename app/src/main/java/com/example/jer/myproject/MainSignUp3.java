...
txt.setText("");
        for(int i=0;i<MainSignUp2.myList.size();i++) {
            txt.append(txt.getText() + MainSignUp.startString + "  " + MainSignUp.stopString + "   " + MainSignUp.StringEdit1 + "  " + MainSignUp.StringEdit2
                    + "  " + MainSignUp.StringEdit3 + "  " + MainSignUp.StringEdit4 + "  " + MainSignUp.StringEdit5
                    + "  " + MainSignUp.StringEdit6 + "  " + MainSignUp.StringEdit7 + "  " + MainSignUp.StringEdit8
                    + "  " + MainSignUp.StringEdit9 + "  " + MainSignUp2.myList.get(i).pro.toString()
                    + "  " + MainSignUp2.myList.get(i).amp.toString() + "  " + MainSignUp2.myList.get(i).pri.toString());
        }
    }
    ...
    public void clickSaveData(View view){
        ...
        builder.setMessage(
                ...
                ("ข้อมูล4:  ") + MainSignUp.StringEdit6 + "\n" +
                ("ข้อมูล5:  ") + MainSignUp.StringEdit7 + "\n" +
                ("ข้อมูล6:  ") + MainSignUp.StringEdit8 + "\n" +
                ("ข้อมูล7:  ") + MainSignUp.StringEdit9 + "\n" +
    ...
    private void updateToMySQL() {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("data4", MainSignUp.StringEdit6));
            nameValuePairs.add(new BasicNameValuePair("data5", MainSignUp.StringEdit7));
            nameValuePairs.add(new BasicNameValuePair("data6", MainSignUp.StringEdit8));
            nameValuePairs.add(new BasicNameValuePair("data7", MainSignUp.StringEdit9));
            ...
            nameValuePairs.add(new BasicNameValuePair("data10", MainSignUp2.myList.get(0).pro.toString()));
            nameValuePairs.add(new BasicNameValuePair("data11", MainSignUp2.myList.get(0).amp.toString()));
            nameValuePairs.add(new BasicNameValuePair("data12", MainSignUp2.myList.get(0).pri.toString()));
